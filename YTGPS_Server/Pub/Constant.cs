...
namespace YTGPS_Server
{
    public class Constant
    {
        ...
        /// GPRS协议5协议B
        /// </summary>
        public const int PROTOCOL_VicZone = 4;
 ...
 /*
        //指令下发
        public const char OD_SET_SMS = 'A'; //设置中心短信号码 0
        public const char OD_SET_SMS_EX = 'B';//设置中心辅助短信号码1
        public const char OD_SET_GPRS = 'C';//设置GPRS中心2
        ...
        public const char OD_SET_PARAM = 'L';//设置终端参数11

        public const char OD_CTR_POINT = 'a';//解除报警0
        public const char OD_CTR_GET_SET = 'b';//重启终端1
        public const char OD_CTR_FREE_ALARM = 'c';//解除报警0
        public const char OD_CTR_REBOOT = 'd';//重启终端1
        public const char OD_CTR_RESET = 'e';//回复出厂设置2
        public const char OD_CTR_QUERY_MILE = 'f';//查询里程3*/
